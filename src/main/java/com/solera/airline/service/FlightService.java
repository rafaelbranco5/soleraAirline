...
public class FlightService {
	...
	private List<Flight> flights = Arrays.asList(
			...
			new Flight(3, "Madrid", "Berlin", 200, LocalDateTime.of(2023, 01, 17, 12, 00), true, 1, "TAP", 2.5),
			new Flight(4, "Madrid", "London", 150, LocalDateTime.of(2023, 01, 9, 12, 00), true, 1, "TAP", 2),
			...
			new Flight(7, "London", "Madrid", 40, LocalDateTime.of(2023, 01, 11, 12, 00), false, 0, "RyanAir", 2),
			new Flight(8, "London", "Munich", 80, LocalDateTime.of(2023, 01, 13, 12, 00), true, 0, "TAP", 2),
			new Flight(9, "London", "Turin", 105, LocalDateTime.of(2023, 01, 8, 12, 00), true, 1, "TAP", 3),
			new Flight(10, "London", "Athens", 175, LocalDateTime.of(2023, 01, 3, 12, 00), true, 2, "EasyJet", 5));
